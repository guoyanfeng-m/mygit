...
function onout(event){
    var obj=document.getElementById("colorpanel");
...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
        	$(".colordiv").remove();
            $("body").append('<div onmouseout="onout()"  id="colorpanel" class="colordiv" style="border:solid 2px red; z-index:20000; position: absolute; display: none;"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;visibility:hidden;" value="#000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" id="_creset">关闭</a></td></tr></table></td></table>'
